...
const Home = () => {
  return (
    <div className='w-full h-screen  ' >
        ...
        <div className='flex justify-center  pt-6 items-center ml-8'>
              ...
              <div className='relative  '>
                  <img className='w-[1216px] h-[550px] object-cover mx-auto rounded-lg mt-8' src="/IMAGES/0ba138a3797a763d4510333166532abb.jpeg" alt="" />
                       
                                                                          {/*IMAGE 1 SECTIONcd  SYNTAX FOR PAGE 2 AS WELL  JUST REMOVE THIS FIRST DIV*/}
                        <div className='absolute inset-72 left-[300px] bg-custom-dark text-white h-[285px] mt-10 w-[598px] p-10 rounded-xl flex flex-col items-center border-solid border border-slate-800  '>
                              <h2 className='  text-base  bg-[#4B6BFB] rounded-lg mr-auto p-1 mb-3'>Technology</h2>
                              <p className='font-semibold text-3xl w-[518]'>The Impact of Technology on the Workplace: How Technology is Changing</p>
                              <div className='flex space-x-4 items-center mr-auto pt-5'>
                                  <img className='w-10 rounded-full ' src="./IMAGES/9a54dc57c3bfdd71f8ab78628ef9ac9a.jpeg" alt="" />
                                  <p>Jason Francisco</p>
                                  <p>August 20, 2022</p>
                              </div>
                        </div>
               ...
               <div className='grid grid-cols-3  px-[210px] mt-8'>
                  ...
                  <div className='border-solid border  border-slate-800 rounded-xl w-[392px] h-[488px] p-4'>
                    ...
                    <div className='flex items-center  justify-center space-x-5 -ml-[60px] mt-3'>
                  ...
                  <div className='border-solid border  border-slate-800 rounded-xl w-[392px] h-[488px] p-4'>
                    ...
                    <div className='flex items-center  justify-center space-x-5  -ml-[40px] mt-3'>
                  ...
                  <div className='border-solid border  border-slate-800 rounded-xl w-[392px] h-[488px] p-4 mr-'>
                  ...
                  <div className='border-solid border mt-5 border-slate-800 rounded-xl w-[392px] h-[488px] p-4'>
                  ...
                  <div className='border-solid border mt-5 border-slate-800 rounded-xl w-[392px] h-[488px] p-4'>
                    ...
                    <div className='flex items-center  justify-center space-x-5 -ml-[95px] mt-3'>
                  ...
                  <div className='border-solid border mt-5 border-slate-800 rounded-xl w-[392px] h-[488px] p-4 mr-'>
