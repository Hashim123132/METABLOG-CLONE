...
const Contact = () => {
  return (
    <div className='flex justify-center items-center h-screen'>
      <div className='bg-[#242535] rounded-lg p-[32px] w-[390px] h-[400px]'>
        ...
        <textarea placeholder='Your Comment' className='rounded-md border-solid border border-[#3B3C4A] text-[#97989F] bg-[#181A2A] block py-[12px] px-[16px] w-[320px] mt-4 h-[60px]'></textarea>
