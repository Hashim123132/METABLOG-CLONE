    ...
    <div className='w-full h-screen  ' >
        ...
        <p className='text-[#696A75] text-[16px]'>Link One</p>                                    
              ...
              <div className='relative  '>
                  <img className='w-[1216px] h-[450px] object-cover mx-auto rounded-lg mt-8' src="/IMAGES/pexels-mintworkspace-28350926.jpg" alt="" />
                       
                                                                          {/*IMAGE 1 SECTIONcd  SYNTAX FOR PAGE 2 AS WELL  JUST REMOVE THIS FIRST DIV*/}
                        <div className='absolute inset-[145px] left-[220px]  text-white font-semibold h-[184px] w-[1136px] mt-10  p-10 rounded-xl flex flex-col items-center   '>
                              <h2 className='  font-medium  bg-[#4B6BFB] rounded-lg  mr-auto p-1 mb-3'>Technology</h2>
                              <p className='font-semibold text-4xl w-[720px] mr-auto'>The Impact of Technology on the Workplace: How Technology is Changing</p>
                              <div className='flex space-x-4 items-center mr-auto pt-5'>
                                  <img className='w-10 rounded-full ' src="./IMAGES/ec54609ce8242bd3168cea0902f3a40f.png" alt="" />
                                  <p>Tracey Wilson</p>
                                  <p>August 20, 2022</p>
                              </div>
                        </div>
